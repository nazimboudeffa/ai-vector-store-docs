...
const document = "a-general-introduction-to-psychoanalysis"

async function generate( apiKey ) {

  const loader = new DirectoryLoader("./docs/"+document+"-data", {
  ...
  const VECTOR_STORE_PATH = "./docs/"+document+"-data-index";
